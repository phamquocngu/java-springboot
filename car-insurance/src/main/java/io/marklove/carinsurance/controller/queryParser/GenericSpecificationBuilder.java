package io.marklove.carinsurance.controller.queryParser;
...
public class GenericSpecificationBuilder<U> {
    ...
    public final GenericSpecificationBuilder<U> with(final String key,
    ...
    public final GenericSpecificationBuilder<U> with(final String precedenceIndicator,
                                                      final String key,
                                                      final String operation,
                                                      final Object value,
                                                      final String prefix,
