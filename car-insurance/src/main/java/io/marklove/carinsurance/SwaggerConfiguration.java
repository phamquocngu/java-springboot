...
public class SwaggerConfiguration {
    ...
    public Docket adminApi() {
        var docket =  new Docket(DocumentationType.OAS_30)
                .groupName("admin")
                .select()
                .apis(RequestHandlerSelectors.basePackage("io.marklove.carinsurance.controller.admin"))
                .paths(PathSelectors.any())
                .build()
                .ignoredParameterTypes(Pageable.class).enableUrlTemplating(false)
                .apiInfo(new ApiInfoBuilder().version("1.0").title("Car Insurance").build());
    ...
    public Docket appApi() {
        var docket =  new Docket(DocumentationType.OAS_30)
                .groupName("app")
                .select()
                .apis(RequestHandlerSelectors.basePackage("io.marklove.carinsurance.controller.app"))
                .paths(PathSelectors.any())
                .build()
                .ignoredParameterTypes(Pageable.class).enableUrlTemplating(false)
                .apiInfo(new ApiInfoBuilder().version("1.0").title("Car Insurance").build());
    ...
    public Docket commonApi() {
        var docket =  new Docket(DocumentationType.OAS_30)
                .groupName("common")
                .select()
                .apis(RequestHandlerSelectors.basePackage("io.marklove.carinsurance.controller"))
