...
@Configuration
@ComponentScan("io.marklove.springboot.securedsockets")
@EnableTransactionManagement
@EnableJpaRepositories("io.marklove.springboot.securedsockets.repository")
public class DataStoreConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        bean.setPackagesToScan("io.marklove.springboot.securedsockets");
